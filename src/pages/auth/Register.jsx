...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response) {
                setError(err.response.data.error_description || err.response.data.msg || "Registrasi gagal");
            } else {
            ...
            <div className="bg-white rounded-3xl overflow-hidden flex min-h-[700px]">
                ...
                <div className="w-1/2 flex items-center justify-center px-20">
                    ...
                    <div className="w-full max-w-sm">
                        ...
                        {/* Success */}
                        {success && (
                            <div className="bg-green-100 text-green-600 p-3 rounded-xl mb-5 text-sm flex items-center">
